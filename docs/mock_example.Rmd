...
filterAndTrim(fwd, fwd_filt, bwd, bwd_filt, truncLen=c(150, 100),
              compress=T, verbose=T, multithread=T)
```
...
```{r}
seqtab <- makeSequenceTable(mergePairs(dadaFs, derepFs, dadaRs, derepRs))
```
